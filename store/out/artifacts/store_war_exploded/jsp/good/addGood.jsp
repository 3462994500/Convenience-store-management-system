...
<div style="width: 500px">
    ...
    <form class="layui-form" action="/addGood">

        <div class="layui-form-item">
            <label class="layui-form-label">商品编号</label>
            <div class="layui-input-block">
                <input type="text" name="goodNum" required  lay-verify="required" placeholder="请输入商品编号" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="vPrice" required  lay-verify="required" placeholder="请输入会员价格" autocomplete="off" class="layui-input">
            </div>
        </div>
